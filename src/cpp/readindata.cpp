...
//   ifstream ostringstream surfdat_stream;
//   double dummy;
//   surfdat_stream << pathToInput << "/surface.dat";
//   ifstream surfdat(surfdat_stream.str().c_str());(surfdat_stream.str().c_str());
//     ifstream surfdat;
...
//                 dummy = 0.;
//                 surfdat.read((char*)&dummy, sizeof(double));
//                 array[ii] = dummy;
//             }
